...
function initAdmin(socket) {
  ...
  socket.on('updateAdminPage', function (ord) {
...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/update-cart", pizza).then(function (res) {
    cartCounter.innerText = res.data.totalQty; // new Noty({
...
addToCart.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var pizza = JSON.parse(btn.dataset.piz);
...
updateStatus(Order);
(0,_stripe__WEBPACK_IMPORTED_MODULE_4__.initStripe)(); //Socket.io
...
/* harmony import */ var _apiServ__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./apiServ */ "./resources/js/apiServ.js");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_2__.loadStripe)('pk_test_51IzSnmSCgNxr33OWcBqLm5zg4OEXlvzg7KNheBnZGjBvyjuD3lnlMxhkvFkMPMFcRmER4mOjTQxOVNEmojUBsf3G00TQedKmKC');
          ...
          case 8:
            ...
            if (paymentForm) {
              paymentForm.addEventListener("submit", function (e) {
                ...
                if (!card) {
                  (0,_apiServ__WEBPACK_IMPORTED_MODULE_1__.placeOrder)(formObject);
                  return;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcloud_kitchen"] = self["webpackChunkcloud_kitchen"] || [];
